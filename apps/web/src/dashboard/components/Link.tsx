...
import { BASE_PATH } from "@dashboard/lib/paths";

// Drop-in for next/link that prefixes the dashboard's BASE_PATH onto internal,
// root-relative hrefs (this app has no Next basePath; the prefix comes from the
// route directory). Idempotent and skips external/relative/already-prefixed hrefs.
