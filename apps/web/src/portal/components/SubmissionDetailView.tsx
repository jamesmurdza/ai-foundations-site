...
/**
 * The full body of a single submission — the post ("photo") on the left, the
 * author header + comment thread on the right. Shared by the standalone
 * `/submissions/[id]` page and the Instagram-style intercepting modal so both
 * render identical content.
 */
export async function SubmissionDetailView({ id }: { id: string }) {
