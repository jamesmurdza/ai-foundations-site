/** Week 4 — trackable checklist for a portfolio + finding your direction. */
...
export const PORTFOLIO_BRIEF = {
  title: "Week 4: Your portfolio & direction",
  intro:
    "This is the week it all comes together. A portfolio is where your projects, your story, and your direction live in one place — the thing you send when someone asks “what have you built?” It's also where you work out what you actually want to build next.",
  sections: [
    {
    ...
    },
    {
      ...
      items: [
        {
          key: "spark",
          label: "Name what genuinely excites you to build",
        },
        {
          key: "direction",
          label: "Pick where to go deeper: a role, a niche, or a project",
        },
        {
          key: "reach",
  ...
  footer:
    "Your portfolio is never “finished” — publish a version you're proud of today, and keep adding to it.",
};
