  ...
  return (
    <section ref={root} className="py-24 md:py-32 border-t">
      <div className="container">
        ...
        <div className="mx-2 md:mx-10 px-6 md:px-12 mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="hh-pillar flex flex-col justify-center gap-6 p-8 rounded-lg border bg-card">
        ...
        <div className="mx-2 md:mx-10 px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="hh-pillar flex flex-col justify-center gap-4">
              {PILLARS.map((p) => (
                <div
                  key={p.eyebrow}
                  className="flex items-start gap-4 p-4 rounded-lg border bg-card text-left"
                >
